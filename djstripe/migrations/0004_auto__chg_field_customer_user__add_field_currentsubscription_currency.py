...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurrentSubscription.currency'
        db.add_column(u'djstripe_currentsubscription', 'currency',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=3),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CurrentSubscription.currency'
        db.delete_column(u'djstripe_currentsubscription', 'currency')
    ...
    models = {
        ...
        u'djstripe.currentsubscription': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'currency': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '3'}),
